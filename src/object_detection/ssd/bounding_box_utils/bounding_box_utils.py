...
def convert_coordinates(tensor: np.ndarray, start_index, conversion, border_pixels='half'):
    """
...
def convert_coordinates2(tensor: np.ndarray, start_index, conversion):
    """
...
def intersection_area(boxes1: np.ndarray, boxes2: np.ndarray, coords='centroids', mode='outer_product', border_pixels='half'):
    """
    ...
    if not (boxes1.shape[1] == boxes2.shape[1] == 4): raise ValueError(
        "All boxes must consist of 4 coordinates, but the boxes in `boxes1` and `boxes2` have {} and {} coordinates, respectively.".format(boxes1.shape[1], boxes2.shape[1]))
...
def iou(boxes1: np.ndarray, boxes2: np.ndarray, coords='centroids', mode='outer_product', border_pixels='half'):
    """
